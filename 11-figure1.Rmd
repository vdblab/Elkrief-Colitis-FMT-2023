...
#comparisons=list(c("Colitis", "nonIBD-symptomatic"), c("Colitis", "nonIBD-asymptomatic"), c("Colitis", "UC"), c("Colitis", "CD"), c("nonIBD", "UC"), c("nonIBD", "UC"), c("nonIBD", "CD"), c("nonIBD", "CD"), c("UC", "CD"))
...
p1b_alpha_species <- ggplot(sample_data(mpa_phy_colitis), aes(x=case, y=InvSimpson)) +
 ...
 xlab("Group") +
  ylab("Diversity (Metaphlan species alpha div)") +
