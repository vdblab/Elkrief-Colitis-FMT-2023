...
hierachical_relab_pre <- bind_rows(
  tax_glom(subset_taxa(mpa_phy_colitis, Genus %in% genera_of_interest), "Kingdom") %>% phy_to_df(),
  tax_glom(subset_taxa(mpa_phy_colitis, Genus %in% genera_of_interest), "Phylum") %>% phy_to_df(),
  tax_glom(subset_taxa(mpa_phy_colitis, Genus %in% genera_of_interest), "Class") %>% phy_to_df(),
  tax_glom(subset_taxa(mpa_phy_colitis, Genus %in% genera_of_interest), "Order") %>% phy_to_df(),
  tax_glom(subset_taxa(mpa_phy_colitis, Genus %in% genera_of_interest), "Family") %>% phy_to_df(),
  tax_glom(subset_taxa(mpa_phy_colitis, Genus %in% genera_of_interest), "Genus") %>% phy_to_df(),
  tax_glom(subset_taxa(mpa_phy_colitis, Genus %in% genera_of_interest), "Species") %>% phy_to_df(),
  ) %>% 
